...
public class FulfillmentCenter {
    ...
    public void removeProduct(Item item) throws IllegalArgumentException{
    ...
    public List<Item> sortByAmount() {
        ...
        Collections.sort(sortedAmount, new NumberComparator());    // sortujemy nasza liste przy uzyciu stworzonego komparatora
